...
def speichern_logik(spieler, einheiten, eingetragen_von, gespielt_am, max_retries=3):
    """
    ...
    for _ in range(max_retries):
        ...
        kosten_fuer_spiel = round(einheiten * cfg.PLATZPREIS * cfg.FAKTOR, 2)
...
def abrechnung_logik(karte):
    ...
    # damit die Summe aller Schulden exakt KARTEN_WERT ergibt (keine
    # Cent-Abweichungen durch unabhängiges Runden je Spieler).
    zielbetrag_cents = round(cfg.KARTEN_WERT * 100)
